...
class HOTEL_MANAGEMENT:
    def __init__(self):
        ...
        self.Entry1.configure(background="light green")
        self.Entry1.configure(disabledforeground="#a3a3a3")
        self.Entry1.configure(font="TkFixedFont")
        self.Entry1.configure(foreground="#000000")
        self.Entry1.configure(insertbackground="sky blue")
        ...
        self.Button1.configure(highlightcolor="orange")
        ...
        self.Message1.configure(highlightcolor="orange")
